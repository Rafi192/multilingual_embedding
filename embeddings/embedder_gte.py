...
v_en = obj_gte_multilingual_embedder.embed("I love cats!")
v_bn = obj_gte_multilingual_embedder.embed("আমি বিড়ালকে ভালোবাসি!")
v_es = obj_gte_multilingual_embedder.embed("¡Me encantan los gatos!")
